...
<div class="w-64">
    ...
    <a href="{{route('threadView.create') }}"  class="block w-full py-4 mb-10  bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-600 text-white/90 font-bold text-center test-center rounded-md ">Preguntar</a>
          ...
          <div class="w-full">
            ...
            <p class="flex items-center justify-between w-full text-xs">
                ...
                <span  class=" flex items-center gap-1 text-slate-700">
                    ...
                    @can('update',$thread)
                    <a href="{{ route('threadView.edit',$thread) }}" class="hover:text-white">Editar</a>  </span>
                    @endcan 
